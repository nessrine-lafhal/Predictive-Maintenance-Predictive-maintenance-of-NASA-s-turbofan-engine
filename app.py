...
def main():
    ...
    st.image('https://external-preview.redd.it/bUF4STRInwvgUWrMFJjJm-G5cNxIyRK5rGRF_bl0xKg.jpg?auto=webp&s=6fbf4c143f0590999dc9f9d127eb32844432424a')

    #Downloading the files
    train_file = st.file_uploader("Upload training data", type=["csv", "txt"])
    test_file = st.file_uploader("Upload testing data", type=["csv", "txt"])
    y_test = st.file_uploader('Upload y_test data', type=['csv','txt'])
